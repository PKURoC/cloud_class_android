...
public class FileUploadPresenter implements FileUploadContract.Presenter {
    ...
    @NonNull
    private final FileUploadContract.View mStorageAllView;
    @NonNull
    ...
    public FileUploadPresenter(@NonNull String requestTag, @NonNull ServerImp serverImp,
                               @NonNull FileUploadContract.View view,
