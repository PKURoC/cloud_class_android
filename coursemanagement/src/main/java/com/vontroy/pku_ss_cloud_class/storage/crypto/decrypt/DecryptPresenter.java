...
public class DecryptPresenter implements DecryptContract.Presenter {
    @NonNull
    ...
    @NonNull
    private final DecryptContract.View mStorageAllView;
    @NonNull
    ...
    public DecryptPresenter(@NonNull String requestTag, @NonNull ServerImp serverImp,
                            @NonNull DecryptContract.View view,
